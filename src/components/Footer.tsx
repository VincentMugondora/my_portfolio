...
const Footer = () => {
  return (
    <footer className="w-full bg-[#18181b] text-gray-400 py-6 px-4 flex flex-col md:flex-row items-center justify-between border-t border-[#23272F] mt-12">
      <div className="text-sm mb-2 md:mb-0">&copy; {new Date().getFullYear()} Vincent Mugondora. All rights reserved.</div>
      <div className="flex items-center gap-4">
        <a href="mailto:vincent@uncommon.org" className="hover:text-blue-400 transition">vincent@uncommon.org</a>
        <a href="https://github.com/vinmugondora" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition" aria-label="GitHub">
        ...
        <a href="https://linkedin.com/in/vincent-mugondora" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition" aria-label="LinkedIn">
