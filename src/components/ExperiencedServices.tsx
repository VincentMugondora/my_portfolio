...
const services = [
  {
    ...
    description: 'Crafting beautiful, responsive websites that are easy to use and aligned with your brand.',
  ...
  },
  {
    number: '02',
    title: 'App Design',
    description: 'Creating functional and visually appealing mobile apps with seamless navigation.',
  ...
  },
  {
    number: '03',
    title: 'Branding',
    description: 'Developing cohesive brand identities, including logos, color schemes, and typography.',
  ...
  },
  {
    ...
    description: 'Designing clear and user-friendly dashboards for effective data visualization and insights.',
