...
const ContactPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#111111] flex flex-col items-center justify-start py-12 px-4">
      ...
      <section className="w-full max-w-xl bg-[#18181b] border border-[#23272F] rounded-2xl shadow-lg p-8 flex flex-col gap-6">
        ...
        <div className="mt-8 text-gray-400 text-sm text-center">
          <div>Email: <a href="mailto:vincentmugondora@gmail.com" className="text-blue-400 underline">vincentmugondora@gmail.com</a></div>
          <div className="mt-2">LinkedIn: <a href="https://www.linkedin.com/in/vincent-mugondora-7b2a922b3" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">vincent-mugondora</a></div>
        </div>
      </section>
    </div>
  );
